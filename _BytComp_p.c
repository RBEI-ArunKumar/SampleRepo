...
extern const MIDL_SERVER_INFO IDataProvider_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IDataProvider_ProxyInfo;
...
/* Object interface: IDataProvider, ver. 0.0,
   GUID={0xA12EAEC2,0x2B64,0x470B,{0x93,0xAF,0xEF,0xE0,0x85,0x5D,0xD3,0xAC}} */

#pragma code_seg(".orpc")
static const unsigned short IDataProvider_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IDataProvider_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &IDataProvider_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IDataProvider_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(8) _IDataProviderProxyVtbl = 
{
    &IDataProvider_ProxyInfo,
    &IID_IDataProvider,
    ...
    (void *) (INT_PTR) -1 /* IDataProvider::GetSafeArray */
};


static const PRPC_STUB_FUNCTION IDataProvider_table[] =
{
...
CInterfaceStubVtbl _IDataProviderStubVtbl =
{
    &IID_IDataProvider,
    &IDataProvider_ServerInfo,
    8,
    &IDataProvider_table[-3],
...
const CInterfaceProxyVtbl * __BytComp_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IDataProviderProxyVtbl,
    0
};

const CInterfaceStubVtbl * __BytComp_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IDataProviderStubVtbl,
    0
};

PCInterfaceName const __BytComp_InterfaceNamesList[] = 
{
    "IDataProvider",
    0
};

const IID *  __BytComp_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define __BytComp_CHECK_IID(n)	IID_GENERIC_CHECK_IID( __BytComp, pIID, n)

int __stdcall __BytComp_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!__BytComp_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo _BytComp_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & __BytComp_ProxyVtblList,
    (PCInterfaceStubVtblList *) & __BytComp_StubVtblList,
    (const PCInterfaceName * ) & __BytComp_InterfaceNamesList,
    (const IID ** ) & __BytComp_BaseIIDList,
    & __BytComp_IID_Lookup, 
    1,
    2,
